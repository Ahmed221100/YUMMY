...
$("#open").click(open);
function open() {
  $(".side-container").animate({ left: "0px" }, 500);
  $("#open").css("display", "none");
  $("#close").css("display", "block");
  $(".side-container ul li:nth-child(1)").animate({ top: "0px" }, 500);
  $(".side-container ul li:nth-child(2)").animate({ top: "0px" }, 600);
  $(".side-container ul li:nth-child(3)").animate({ top: "0px" }, 700);
  $(".side-container ul li:nth-child(4)").animate({ top: "0px" }, 800);
  $(".side-container ul li:nth-child(5)").animate({ top: "0px" }, 900);
}
$("#close").click(close);
function close() {
  $(".side-container").animate({ left: -`${widthSlider}` }, 500);
  $("#close").css("display", "none");
  $("#open").css("display", "block");
  $(".side-container ul li:nth-child(1)").animate({ top: "300px" }, 900);
  $(".side-container ul li:nth-child(2)").animate({ top: "300px" }, 800);
  $(".side-container ul li:nth-child(3)").animate({ top: "300px" }, 700);
...
function displayMeals(meal, idContainer) {
  ...
  <div class="col-xl-3 col-lg-4 col-md-6">
    <div  onclick="displayDetails(${i}) "  class="card-content rounded-3 overflow-hidden position-relative">
  ...
  for (let i = 0; i < 20; i++) {
    ...
    <div class="col-md-6 col-lg-4 col-xl-3">
      <div onclick="displayRel(${i})" class="content text-center text-white">
          ...
          <p>${meal[i].strDescription.split(" ", 25).join(" ")}</p>
      </div>
    </div>`;
  }
  idContainer.innerHTML = box;
...
function validation() {
  ...
  if ( validateName() &&validateEmail() && validatePhone() && validateAge() && validatePassword() && validateRePassword() && passwordInput.value == repasswordInput.value ) {
